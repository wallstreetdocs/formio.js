...
export default class BaseComponent extends Component {
	...
	constructor ( component, options, data ) {
		...
		/**
		 * The basic component information which tells the BaseComponent how to render the input element of the
		 * components that derive from this class.
		 * @type {null}
		 */
		this.info = null;
		...
		if ( this.component.refreshOn ) {
			this.on ( 'change', ( event ) => {
				if ( this.component.refreshOn === 'data' ) {
					...
					// Make sure the changed component is not in a different "context". Solves issues where refreshOn
					// being set in fields inside EditGrids could alter their state from other rows (which is bad).
