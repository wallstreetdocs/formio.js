...
export default class Webform extends NestedComponent {
	 ...
	 * @param {boolean} options.i18n - The translation file for this rendering. @see
	 *     https://github.com/formio/formio.js/blob/master/i18n.js
	 * @param {boolean} options.template - Provides a way to inject custom logic into the creation of every element
	 *     rendered within the form.
	 */
	 ...
	 * });
	 *
	 * @param {Object} form - The JSON schema of the form @see https://examples.form.io/example for an example JSON
	 *     schema.
	 * @returns {*}
	 */
	setForm ( form ) {
