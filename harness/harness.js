...
(function ( $ ) {
	...
	window.WSDFormIO = {
		...
		getValue: function ( path ) {
			...
			console.log ( 'getValue', path, objectPath.get ( WSDFormIO.FormData, path ) );

			return objectPath.get ( WSDFormIO.FormData, path );
		},
	...
	$ ( document ).ready ( function () {
		...
		Formio.createForm (
			document.getElementById ( 'form_embed__vehicletest' ),
